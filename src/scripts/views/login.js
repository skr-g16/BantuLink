...
const loadLoginPage = () => {
  ...
  <div class="card">
          <div class="card2">
              <form class="form" id="loginForm"> <!-- Tambahkan ID di sini -->
                  ...
                  <div class="field">
                      ...
                      <input id="username" type="text" class="input-field" placeholder="Username" autocomplete="off" />
                  </div>
                  <div class="field">
                      <svg viewBox="0 0 16 16" fill="currentColor" height="16" width="16"
                          xmlns="http://www.w3.org/2000/svg" class="input-icon">
                  ...
                  <div class="btn">
                      <button type="submit" class="button1"> <!-- Tambahkan type="submit" -->
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Login&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      </button>
  ...
  // Menangani submit form setelah elemen ditambahkan ke DOM
